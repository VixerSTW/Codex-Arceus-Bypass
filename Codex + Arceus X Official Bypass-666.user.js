...
// @version      666
// @description  The only and offical bypass for Codex & Arceus X (by Vixer). None other will update daily. Abuses Arceus's API. ~5 seconds to do. Fakes Codex's API. ~30 seconds to do.
// @author       Vixer
...
if (window.location.hostname == 'mobile.codex.lol') {
    codexBypass();
} else {
    keySystem();
}